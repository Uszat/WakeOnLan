...
char ssid[] = "Usaty2021";         // your network SSID (name)
char password[] = "94637410"; // your network password

// Get from the "botFather" on telegram
#define TELEGRAM_BOT_TOKEN "1756926310:AAFV3w12ShhRYc7ampn6b_DOqG7zCHU57Ls"
...
uint8_t MAC[6] = {0xFC, 0xAA, 0x14, 0x1F, 0x9A, 0x0B}; //here input target device mac address

targetDevice devices[] ={
  {{0x40, 0x8D, 0x5C, 0xB7, 0xC3, 0xD3 }, "KNZ_PC"} //BC-5F-F4-FF-FF-FF  D4-81-D7-B1-AE-A0 CURRENTLY UNSUSED
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (bot.messages[i].type ==  F("callback_query")) {
      ...
      if (text.startsWith("WOL")) {
        ...
        WOL.sendMagicPacket(MAC ,sizeof(MAC), 9);
      }
    } else {
